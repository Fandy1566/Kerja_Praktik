    ...
    if (jadwalDetails.length != 0) {
        function renderTable() {
            ...
            table_content += `
                <thead>
                    <tr>
                        <th scope="row" class="freeze-vertical freeze-horizontal" style="left: 0px">Hari</th>
                        <th scope="row" class="freeze-vertical freeze-horizontal" style="left: 101px">Waktu</th>
            `
